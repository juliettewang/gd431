// Remove helper class if user has JS turned on.
document.documentElement.classList.remove("js-off");

// Is user expecting swipe to work?
...
// Create eventListeners for mouseevents
// (if you do this, must update layout so buttons aren't causing conflicts and wackiness)
